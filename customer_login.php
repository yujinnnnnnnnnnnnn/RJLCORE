...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST['action']) && $_POST['action'] === 'login') {
        ...
        if ($result['success'] && $result['user']['role_name'] !== 'customer') {
            $auth->logout();
            $result = [
                'success' => false,
                'message' => 'This portal is for customers only. Please use the staff login.'
            ];
        }
...
<body style="background: linear-gradient(135deg, var(--green) 0%, var(--beige) 100%); min-height: 100vh; display: flex; align-items: center; justify-content: center;">
    ...
    <div class="container" style="max-width: 400px;">
        <div class="card" style="animation: slideInUp 0.6s ease-out;">
            <div class="text-center mb-4">
                ...
                <p class="text-gray">Access your account and manage purchases</p>
            </div>
            ...
            <form method="POST" class="ajax-form" action="customer_login.php">
            ...
            <div class="text-center">
                <a href="customer_forgot_password.php" style="color: var(--navy); text-decoration: none;">
            ...
            <div class="text-center">
                <p style="margin-bottom: 1rem; color: var(--gray);">Don't have an account?</p>
                <a href="customer_register.php" class="btn btn-success" style="width: 100%; margin-bottom: 1rem;">
